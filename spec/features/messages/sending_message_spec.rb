...
RSpec.feature 'Sending a message' do
  before do
    ...
    @sarah = User.create!(first_name: 'Sarah', last_name: 'Johnson', email: 'sarah@example.com', password: 'password')
    @henry = User.create!(first_name: 'Henry', last_name: 'Sarahson', email: 'Henry@example.com', password: 'password')
